...
public class WebTableUtils {
    ...
    public static String returnOrderDate(WebDriver driver, String costumerName) {
        ...
        WebElement costumerOrderDate1 = driver.findElement(By.xpath(locator));


        return costumerOrderDate1.getText();
    ...
    public static void orderVerify(WebDriver driver, String costumerName, String expectedOrderDate){
        ...
        WebElement costumerOrderDate = driver.findElement(By.xpath("//td[.='" + costumerName + "']/following-sibling::td[3]"));
