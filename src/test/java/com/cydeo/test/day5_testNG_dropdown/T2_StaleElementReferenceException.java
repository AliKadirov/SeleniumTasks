...
public class T2_StaleElementReferenceException {
    public static void main(String[] args) {
        ...
        try {
            System.out.println(deleteButton.isDisplayed() + " Delete button is displayed");

        }catch (StaleElementReferenceException e){
            System.out.println("Stale Element Reference Exception is thrown and this is already excepted!");
        }
