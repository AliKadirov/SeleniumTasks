...
public class LibraryLoginPage {
    ...
    It has method called initElement. Once it's called it will store all elements specified using @FindBy annotation with locator, and it will give elements to the classes when they called initElements method accept 2 arg
